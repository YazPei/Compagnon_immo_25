...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        response.headers["X-Service-Name"] = getattr(
            settings, "PROJECT_NAME", "Compagnon Immobilier"
        )
...
class APIVersionMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        self, app, current_version: str = None, deprecated_versions: List[str] = None
    ):
        super().__init__(app)
        self.current_version = current_version or getattr(
...
class CORSSecurityMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        self, app, allowed_origins: List[str] = None, strict_mode: bool = None
    ):
        super().__init__(app)
        self.allowed_origins = allowed_origins or getattr(settings, "CORS_ORIGINS", [])
        self.strict_mode = strict_mode or (
