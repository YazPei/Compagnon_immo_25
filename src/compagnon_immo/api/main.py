...
from compagnon_immo.api.config.settings import settings
from compagnon_immo.api.middleware.error_handling import ErrorHandlingMiddleware
from compagnon_immo.api.routes import estimation as estimation_routes
from compagnon_immo.api.routes import health as health_routes
from compagnon_immo.api.routes import historique as historique_routes
from compagnon_immo.api.routes import main as main_routes
from compagnon_immo.api.routes import metrics as metrics_routes
# Importation des gestionnaires d'exceptions personnalisés
from compagnon_immo.api.utils.exception_handlers import http_exception_handler
