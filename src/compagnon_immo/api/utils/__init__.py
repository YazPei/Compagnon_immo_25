...
# 1) importer le module pour que 'from compagnon_immo.api.utils import model_loader' donne bien un module
from . import model_loader as model_loader  # noqa: F401
# 2) ré-exporter les fonctions pour 'from compagnon_immo.api.utils import get_model'
