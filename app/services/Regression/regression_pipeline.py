...
@click.option(
    ...
    help="Chemin vers df_cluster.csv",
)
@click.option(
    "--output",
    default="./encoded",
    prompt="Dossier de sortie encodé",
    help="Dossier de sortie pour les jeux encodés",
)
...
@click.option(
    "--encoded-folder",
    default="./encoded",
    prompt="Dossier des données encodées",
    help="Dossier contenant les données encodées",
)
...
@click.option(
    ...
    default="./encoded",
    prompt="Dossier des données encodées",
    help="Dossier contenant X_train/X_test et le modèle",
)
@click.option(
    "--model",
    type=click.Choice(["lightgbm", "xgboost"]),
    prompt="Modèle à analyser",
