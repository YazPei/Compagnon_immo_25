        ...
        if file.endswith(".csv") and "cluster_" in file:
            ...
            with mlflow.start_run(run_name=f"sarimax_cluster_{cluster_id}"):
                ...
                try:
                    ...
                    # Sauvegarde
                    save_path = os.path.join(output_folder, f"sarimax_model_cluster_{cluster_id}.pkl")
                    ...
                    forecast_df.to_csv(os.path.join(output_folder, f"forecast_cluster_{cluster_id}.csv"), sep=';')
                    mlflow.log_artifact(os.path.join(output_folder, f"forecast_cluster_{cluster_id}.csv"))
